function [x,y] = problem2a_usingode45(a,c)
...
[x,y] = ode45(@odefun, [0 params.L], y0, [], params);

%calculate the cputime taken by the ode solver.
totaltime = (cputime-start);
output = strcat('The time taken by ode45 = \t',num2str(totaltime),' s\n');
fprintf(output);
...
figure
plot(x*100,y(:,1));
title('The Temperature in the filter calculated using ode45');
xlabel('Distance (cm)');
